function e(e){return e&&e.__esModule?e.default:e}var t,i="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},a={},o={},n=i.parcelRequire34ff;null==n&&((n=function(e){if(e in a)return a[e].exports;if(e in o){var t=o[e];delete o[e];var i={id:e,exports:{}};return a[e]=i,t.call(i.exports,i,i.exports),i.exports}var n=Error("Cannot find module '"+e+"'");throw n.code="MODULE_NOT_FOUND",n}).register=function(e,t){o[e]=t},i.parcelRequire34ff=n),n("bUb57");var r=n("e0qAQ"),s=n("3OIsu"),l=n("bh4hP"),c=n("b3SuP");const d=async()=>{let e="",t="background-size: cover";try{let{results:i}=await (0,r.fetchTrendingMoviesByDay)(),{id:a,title:o,overview:n,backdrop_path:d,vote_average:p}=i[Math.floor(20*Math.random())+0],u=`https://image.tmdb.org/t/p/original/${d}`;window.innerWidth<768&&(t="background-size: 768px; background-position: center"),e=`
      ...
      </div>`,l.heroRefs.heroContainer.innerHTML=e;let _=document.getElementById("watch-trailer");_.addEventListener("click",e=>(0,s.onTrailerBtnClick)(e));let h=document.querySelector(".hero__btn.m-modal");h.addEventListener("click",e=>(0,c.onOpenModalFilm)(e))}catch(t){(0,l.heroRefs).heroContainer.classList.toggle("hero--bg"),e=`
      ...
      </div>`,l.heroRefs.heroContainer.innerHTML=e}};d();var p=n("7Y9D8"),u=n("2shzp");const _={method:"GET",headers:{accept:"application/json",Authorization:"Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJjY2FhN2IzMjk5NmM0N2RhMTQxZWI1N2IwZTVjZTQ3NiIsInN1YiI6IjY0N2M5OTdkZTMyM2YzMDEyNzUyM2IzNiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.Blrs7t4WoJ6-3sy6A_Vz3twkTCmEg9nM0JyuAHg88WM"}};async function h(){try{let e=await (0,u.default).get("https://api.themoviedb.org/3/movie/upcoming",_);return e.data}catch(e){console.log(e),Notiflix.Notify.failure("Oops! Something went wrong. Try again, please!")}}var g=n("2eUFK");let v="";const m=e(g).genres,y=document.querySelector(".upcoming");h().then(e=>{!function({results:e}){let t;let i=Math.floor(Math.random()*e.length),{adult:a,backdrop_path:o,genre_ids:n,id:r,original_language:s,original_title:l,overview:c,popularity:d,poster_path:p,release_date:u,title:_,video:h,vote_average:g,vote_count:f}=e[i];t=[],n.forEach(e=>{m.forEach(i=>{e===i.id&&t.push(i.name)})}),v=t.length>2?`${t[0]} and others...`:2===t.length?`${t[0]}, ${t[1]}`:`${t[0]}`,y.innerHTML=`<div class="container">
    ...
    </div>`,document.querySelector("#addToMyLibrary")}(e)}).catch(t=>{console.log(t),e(p).Notify.failure("Oops! Something went wrong. Try again, please!")});var g=n("2eUFK"),f=n("hmX5O"),b=n("76tat");const M={movieList:document.querySelector(".list-movie-card")};var u=n("2shzp");const w={headers:{Authorization:"Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJkMmFhZDQ4MjlkYjI1ZWQ1Mjc0NmY0NmY4YzQ1NzRlYSIsInN1YiI6IjY0NzIzZDc3OWFlNjEzMDBjNGM3NmY1NCIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.v_Pd0M6hpO0qy1_8-nNBGtFxbeHjE8i8mgfszlHvjZc",accept:"application/json"}};async function I(e=1){try{let t=await (0,u.default).get(`https://api.themoviedb.org/3/trending/movie/week?language=en-US&page=${e}`,w);return t.data}catch(e){console.log(e)}}if(M.movieList){;let i={};e(g).genres.forEach(e=>{i[e.id]=e.name}),t=i,I().then(e=>{(function({results:e},t){let i=function(e){let t=[];for(;t.length<3;){let i=Math.floor(Math.random()*e.length);t.includes(i)||t.push(i)}return t}(e),a=i.map(t=>e[t]);M.movieList.innerHTML=a.map(f.default).join(""),(0,b.default)(),M.movieList.addEventListener("click",onOpenModalFilm),window.addEventListener("keydown",onEscKeyPress)})(e,0)}).catch(e=>console.log(e))}n("1Hrz4"),n("epHO8"),n("5kw5v");
//# sourceMappingURL=index.987059cb.js.map
