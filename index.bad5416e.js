...
</div>`,function(){let e=document.querySelector("#addToMyLibrary");console.log(e)}()}(t)}).catch(e=>console.log(e));var g=o("XcJ0g"),r=o("dIxxU"),g=o("XcJ0g"),_=({poster_path:t,title:a,vote_average:i,genre_ids:n,release_date:o,id:r})=>{let l={},s="";return e(g).genres.forEach(e=>{l[e.id]=e.name}),n.length>0&&(s=1===n.length||n.join(", ").length<=20?l[n[0]]:`${l[n[0]]}, ${l[n[1]]}`),`<li class='item-movie-card' data-genres='${n}' data-id='${r}'>
