!function(){function e(e){return e&&e.__esModule?e.default:e}var t="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},a={},i={},o=t.parcelRequire34ff;null==o&&((o=function(e){if(e in a)return a[e].exports;if(e in i){var t=i[e];delete i[e];var o={id:e,exports:{}};return a[e]=o,t.call(o.exports,o,o.exports),o.exports}var n=Error("Cannot find module '"+e+"'");throw n.code="MODULE_NOT_FOUND",n}).register=function(e,t){i[e]=t},t.parcelRequire34ff=o),o("i8Q71");var n=o("8yl2Y"),r=o("faU4B"),l=o("6U7c4"),s=o("16wVm");let c=async()=>{let e="",t="background-size: cover";try{let{results:a}=await (0,n.fetchTrendingMoviesByDay)(),{id:i,title:o,overview:c,backdrop_path:d,vote_average:p}=a[Math.floor(20*Math.random())+0],u=`https://image.tmdb.org/t/p/original/${d}`;window.innerWidth<768&&(t="background-size: 768px; background-position: center"),e=`
      ...
      </div>`,l.heroRefs.heroContainer.innerHTML=e}};c();var d=o("6JpON"),p=o("dIxxU");let u={method:"GET",headers:{accept:"application/json",Authorization:"Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJjY2FhN2IzMjk5NmM0N2RhMTQxZWI1N2IwZTVjZTQ3NiIsInN1YiI6IjY0N2M5OTdkZTMyM2YzMDEyNzUyM2IzNiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.Blrs7t4WoJ6-3sy6A_Vz3twkTCmEg9nM0JyuAHg88WM"}};async function _(){try{let e=await (0,p.default).get("https://api.themoviedb.org/3/movie/upcoming",u);return e.data}catch(e){console.log(e),Notiflix.Notify.failure("Oops! Something went wrong. Try again, please!")}}var h=o("XcJ0g");let g="",v=e(h).genres,m=document.querySelector(".upcoming");_().then(e=>{!function({results:e}){let t;let a=Math.floor(Math.random()*e.length),{adult:i,backdrop_path:o,genre_ids:n,id:r,original_language:l,original_title:s,overview:c,popularity:d,poster_path:p,release_date:u,title:_,video:h,vote_average:f,vote_count:y}=e[a];t=[],n.forEach(e=>{v.forEach(a=>{e===a.id&&t.push(a.name)})}),g=t.length>2?`${t[0]} and others...`:2===t.length?`${t[0]}, ${t[1]}`:`${t[0]}`,m.innerHTML=`<div class="container">
          ...
          <li class="upcoming__list-info--left">
            ...
            <div class="upcoming__vote">
              ...
              <p class="upcoming__vote--value">
                <span class="upcoming__vote--value-average">${f}</span> /
    ...
    </div>`,document.querySelector("#addToMyLibrary")}(e)}).catch(t=>{console.log(t),e(d).Notify.failure("Oops! Something went wrong. Try again, please!")});var h=o("XcJ0g"),f=o("6sNo0"),y=o("14Rx2");let b={movieList:document.querySelector(".list-movie-card")};var p=o("dIxxU");let M={headers:{Authorization:"Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJkMmFhZDQ4MjlkYjI1ZWQ1Mjc0NmY0NmY4YzQ1NzRlYSIsInN1YiI6IjY0NzIzZDc3OWFlNjEzMDBjNGM3NmY1NCIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.v_Pd0M6hpO0qy1_8-nNBGtFxbeHjE8i8mgfszlHvjZc",accept:"application/json"}};async function I(e=1){try{let t=await (0,p.default).get(`https://api.themoviedb.org/3/trending/movie/week?language=en-US&page=${e}`,M);return t.data}catch(e){console.log(e)}}var s=o("16wVm");if(b.movieList){let t={};e(h).genres.forEach(e=>{t[e.id]=e.name}),function(e){I().then(t=>{(function({results:e},t){let a=function(e){let t=[];for(;t.length<3;){let a=Math.floor(Math.random()*e.length);t.includes(a)||t.push(a)}return t}(e),i=a.map(t=>e[t]);(function(e){b.movieList.innerHTML=e.map(f.default).join(""),(0,y.default)();let t=document.querySelector(".list-movie-card.js-gallery");t.addEventListener("click",e=>{let t=e.target.parentNode.dataset.id;(0,s.onOpenModalFilmById)(t)})})(i,t)})(t,e)}).catch(e=>console.log(e))}(t)}o("bf8lc"),o("7hKzD"),o("cs2b8")}();
//# sourceMappingURL=index.7ad61997.js.map
