!function(){function e(e){return e&&e.__esModule?e.default:e}var a,t="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},i={},n={},r=t.parcelRequire34ff;null==r&&((r=function(e){if(e in i)return i[e].exports;if(e in n){var a=n[e];delete n[e];var t={id:e,exports:{}};return i[e]=t,a.call(t.exports,t,t.exports),t.exports}var r=Error("Cannot find module '"+e+"'");throw r.code="MODULE_NOT_FOUND",r}).register=function(e,a){n[e]=a},t.parcelRequire34ff=r),r("i8Q71");var s=r("dIxxU"),l=r("faU4B");let o={headers:{Authorization:"Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIzMWYwYzIyMWE2YTRjMTZkOTRjZTUwMDIzYjU4MzMzYiIsInN1YiI6IjY0NGZiYzBhMjNhMzE0MDJlNTdjM2Q0NiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.kZBqemQQaP5AfqtlQ7E69qa116O60SNbbfSuHzK1gjU",accept:"application/json"}},d=document.querySelector(".hero"),c=async()=>{try{let e=await (0,s.default).get("https://api.themoviedb.org/3/trending/movie/day?language=en-US",o);return e.data}catch(e){console.log(e)}},p=async()=>{let e="";try{let{results:a}=await c(),{id:t,title:i,overview:n,poster_path:r,backdrop_path:s,vote_average:l}=a[Math.floor(20*Math.random())+0];e=`
      ...
      </div>`}catch(a){d.classList.toggle("hero--bg"),e=`
      ...
      </div>`}finally{d.innerHTML=e;let a=document.getElementById("watch-trailer");a&&a.addEventListener("click",e=>{(0,l.onTrailerBtnClick)(e)})}};p();var s=r("dIxxU"),v={};v=JSON.parse('{"genres":[{"id":28,"name":"Action"},{"id":12,"name":"Adventure"},{"id":16,"name":"Animation"},{"id":35,"name":"Comedy"},{"id":80,"name":"Crime"},{"id":99,"name":"Documentary"},{"id":18,"name":"Drama"},{"id":10751,"name":"Family"},{"id":14,"name":"Fantasy"},{"id":36,"name":"History"},{"id":27,"name":"Horror"},{"id":10402,"name":"Music"},{"id":9648,"name":"Mystery"},{"id":10749,"name":"Romance"},{"id":878,"name":"Science Fiction"},{"id":10770,"name":"TV Movie"},{"id":53,"name":"Thriller"},{"id":10752,"name":"War"},{"id":37,"name":"Western"}]}');let u=document.querySelector(".upcoming"),h={method:"GET",headers:{accept:"application/json",Authorization:"Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJjY2FhN2IzMjk5NmM0N2RhMTQxZWI1N2IwZTVjZTQ3NiIsInN1YiI6IjY0N2M5OTdkZTMyM2YzMDEyNzUyM2IzNiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.Blrs7t4WoJ6-3sy6A_Vz3twkTCmEg9nM0JyuAHg88WM"}};(async function(){try{let e=await (0,s.default).get("https://api.themoviedb.org/3/movie/upcoming",h);return console.log(e.data),e.data}catch(e){console.log(e)}})().then(e=>{console.log(e),function({results:e}){let a=Math.floor(Math.random()*e.length),{adult:t,backdrop_path:i,genre_ids:n,id:r,original_language:s,original_title:l,overview:o,popularity:d,poster_path:c,release_date:p,title:v,video:h,vote_average:m,vote_count:g}=e[a];u.innerHTML=`<div class="container">
...
</div>`}(e)}).catch(e=>console.log(e));var s=r("dIxxU"),m=({poster_path:a,title:t,vote_average:i,genre_ids:n,release_date:r,id:s})=>{let l={},o="";return e(v).genres.forEach(e=>{l[e.id]=e.name}),n.length>0&&(o=1===n.length||n.join(", ").length<=20?l[n[0]]:`${l[n[0]]}, ${l[n[1]]}`),`<li class='item-movie-card' data-genres='${n}' data-id='${s}'>
