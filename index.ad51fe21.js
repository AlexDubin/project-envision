function e(e){return e&&e.__esModule?e.default:e}var t="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},a={},i={},o=t.parcelRequire34ff;null==o&&((o=function(e){if(e in a)return a[e].exports;if(e in i){var t=i[e];delete i[e];var o={id:e,exports:{}};return a[e]=o,t.call(o.exports,o,o.exports),o.exports}var n=Error("Cannot find module '"+e+"'");throw n.code="MODULE_NOT_FOUND",n}).register=function(e,t){i[e]=t},t.parcelRequire34ff=o),o("bUb57");var n=o("e0qAQ"),r=o("3OIsu"),l=o("bh4hP"),s=o("b3SuP");const c=async()=>{let e="",t="background-size: cover";try{let{results:a}=await (0,n.fetchTrendingMoviesByDay)(),{id:i,title:o,overview:c,backdrop_path:d,vote_average:u}=a[Math.floor(20*Math.random())+0],p=`https://image.tmdb.org/t/p/original/${d}`;window.innerWidth<768&&(t="background-size: 768px; background-position: center"),e=`
      ...
      </div>`,l.heroRefs.heroContainer.innerHTML=e}};c();var d=o("7Y9D8"),u=o("2shzp");const p={method:"GET",headers:{accept:"application/json",Authorization:"Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJjY2FhN2IzMjk5NmM0N2RhMTQxZWI1N2IwZTVjZTQ3NiIsInN1YiI6IjY0N2M5OTdkZTMyM2YzMDEyNzUyM2IzNiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.Blrs7t4WoJ6-3sy6A_Vz3twkTCmEg9nM0JyuAHg88WM"}};async function _(){try{let e=await (0,u.default).get("https://api.themoviedb.org/3/movie/upcoming",p);return e.data}catch(e){console.log(e),Notiflix.Notify.failure("Oops! Something went wrong. Try again, please!")}}var h=o("2eUFK"),g=o("8Emoy");let v="";const m=e(h).genres,f=document.querySelector(".upcoming");_().then(e=>{!function({results:e}){let t;let a=Math.floor(Math.random()*e.length),{adult:i,backdrop_path:o,genre_ids:n,id:r,original_language:l,original_title:s,overview:c,popularity:d,poster_path:u,release_date:p,title:_,video:h,vote_average:y,vote_count:b}=e[a];t=[],n.forEach(e=>{m.forEach(a=>{e===a.id&&t.push(a.name)})}),v=t.length>2?`${t[0]} and others...`:2===t.length?`${t[0]}, ${t[1]}`:`${t[0]}`,f.innerHTML=`<div class="container">
    ...
    <div class="upcoming__block">
      ...
      <div class="upcoming__info">
        ...
        <ul class="list upcoming__list-info">
          <li class="upcoming__list-info--left">
            <div class="upcoming__release-date">
              ...
              <p class="upcoming__release-date--value">${p}</p>
            </div>
        ...
        <button class="upcoming__addToLibrary-button" type="button" data-id="${r}" id="addToMyLibrary">
        Add to my library
        </button>
        </div>
      </div>
    </div>`,function(){let e=document.querySelector("#addToMyLibrary");(0,g.default)(e)}()}(e)}).catch(t=>{console.log(t),e(d).Notify.failure("Oops! Something went wrong. Try again, please!")});var h=o("2eUFK"),y=o("hmX5O"),b=o("76tat");const M={movieList:document.querySelector(".list-movie-card")};var u=o("2shzp");const I={headers:{Authorization:"Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJkMmFhZDQ4MjlkYjI1ZWQ1Mjc0NmY0NmY4YzQ1NzRlYSIsInN1YiI6IjY0NzIzZDc3OWFlNjEzMDBjNGM3NmY1NCIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.v_Pd0M6hpO0qy1_8-nNBGtFxbeHjE8i8mgfszlHvjZc",accept:"application/json"}};async function N(e=1){try{let t=await (0,u.default).get(`https://api.themoviedb.org/3/trending/movie/week?language=en-US&page=${e}`,I);return t.data}catch(e){console.log(e)}}var s=o("b3SuP");if(M.movieList){let t={};e(h).genres.forEach(e=>{t[e.id]=e.name}),function(e){N().then(t=>{(function({results:e},t){let a=function(e){let t=[];for(;t.length<3;){let a=Math.floor(Math.random()*e.length);t.includes(a)||t.push(a)}return t}(e),i=a.map(t=>e[t]);(function(e){M.movieList.innerHTML=e.map(y.default).join(""),(0,b.default)();let t=document.querySelector(".list-movie-card.js-gallery");t.addEventListener("click",e=>{let t=e.target.closest(".m-modal");if(!t)return;let a=t.dataset.id;(0,s.onOpenModalFilmById)(a)})})(i,t)})(t,e)}).catch(e=>console.log(e))}(t)}o("1Hrz4"),o("5kw5v");
//# sourceMappingURL=index.ad51fe21.js.map
