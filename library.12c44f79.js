function e(e){return e&&e.__esModule?e.default:e}var t="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},i={},a={},n=t.parcelRequire34ff;null==n&&((n=function(e){if(e in i)return i[e].exports;if(e in a){var t=a[e];delete a[e];var n={id:e,exports:{}};return i[e]=n,t.call(n.exports,n,n.exports),n.exports}var r=Error("Cannot find module '"+e+"'");throw r.code="MODULE_NOT_FOUND",r}).register=function(e,t){a[e]=t},t.parcelRequire34ff=n),n("bUb57");var r=n("e0qAQ"),l=n("3OIsu"),d=n("bh4hP"),s=n("b3SuP");const o=async()=>{let e="",t="background-size: cover";try{let{results:i}=await (0,r.fetchTrendingMoviesByDay)(),{id:a,title:n,overview:o,backdrop_path:c,vote_average:u}=i[Math.floor(20*Math.random())+0],h=`https://image.tmdb.org/t/p/original/${c}`;window.innerWidth<768&&(t="background-size: 768px; background-position: center"),e=`
      ...
      </div>`,d.heroRefs.heroContainer.innerHTML=e;let v=document.getElementById("watch-trailer");v.addEventListener("click",e=>(0,l.onTrailerBtnClick)(e));let g=document.querySelector(".hero__btn.m-modal");g.addEventListener("click",e=>(0,s.onOpenModalFilm)(e))}catch(t){(0,d.heroRefs).heroContainer.classList.toggle("hero--bg-lib"),e=`
      <div class="container">
      ...
      </div>`,d.heroRefs.heroContainer.innerHTML=e}finally{}};o();var c=n("hmX5O"),u=n("8nTeF"),h=n("76tat"),v=n("kD6p4"),s=n("b3SuP"),g=n("l9dPk"),f=n("170nP"),_=n("2eUFK"),m=n("gjiCh");let p=1;function b(e){(0,g.default).moviesListEl.insertAdjacentHTML("beforeend",e.map(c.default).join("")),g.default.moviesListEl.dataset.page=p,(0,h.default)()}async function y(){let e=await (0,m.default)((0,v.loadMovies)(9));if(0===e.length){(0,g.default).emptyLibEl.classList.remove("is-hidden"),(0,g.default).libCatalogEl.classList.add("is-hidden");return}e.length<9&&(0,g.default).loadMoreBtnEl.classList.add("is-hidden"),b(e);let t=document.querySelector(".list-movie-card.js-gallery");t.addEventListener("click",e=>{let t=e.target.closest(".m-modal");if(!t)return;let i=t.dataset.id;(0,s.onOpenModalFilmById)(i)})}function E(e){let t=g.default.moviesListEl.childNodes,i=e.target.value;"-1"===i?t.forEach(e=>e.classList.remove("is-hidden")):t.forEach(e=>{e.dataset.genres.split(",").includes(i)?e.classList.remove("is-hidden"):e.classList.add("is-hidden")})}async function w(){!function(){g.default.genresSelectEl.customSelect.value="-1";let e=new Event("change");(0,g.default).genresSelectEl.dispatchEvent(e)}();let e=await (0,m.default)((0,v.loadMovies)(9,p));e.length<9&&(0,g.default).loadMoreBtnEl.classList.add("is-hidden"),p+=1,b(e)}window.addEventListener("DOMContentLoaded",function(){(0,u.default)(e(_).genres,g.default.genresSelectEl),y();let t=e(f)(g.default.genresSelectEl)[0];t.select.addEventListener("change",E),(0,g.default).loadMoreBtnEl.addEventListener("click",w)}),n("1Hrz4"),n("5kw5v");
//# sourceMappingURL=library.12c44f79.js.map
