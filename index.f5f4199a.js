...
</div>`,function(){let e=document.querySelector("#addToMyLibrary");console.log(e)}()}(t)}).catch(e=>console.log(e));var p=(o("2eUFK"),o("2eUFK")),h=({poster_path:t,title:a,vote_average:i,genre_ids:n,release_date:o,id:s})=>{let r={},l="";return e(p).genres.forEach(e=>{r[e.id]=e.name}),n.length>0&&(l=1===n.length||n.join(", ").length<=20?r[n[0]]:`${r[n[0]]}, ${r[n[1]]}`),`<li class='item-movie-card m-modal' data-genres='${n}' data-id='${s}'>
